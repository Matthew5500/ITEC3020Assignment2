...
if (registerForm) {
  registerForm.addEventListener('submit', function(e) {
    ...
    if (storedUser) {
      ...
      if (account.username === username || account.email === email) {
        console.log("An account with this username or email already exists. Please click the login button.");
        alert("An account with this username or email already exists. Please click the login button.");
        return;
      }
    }

    // If no duplicate found, store the new account.
  ...
  trainFareForm.addEventListener('submit', function(e) {
    ...
    // Debug: log the promo code value
